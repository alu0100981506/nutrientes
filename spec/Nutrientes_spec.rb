...
describe "Index" do
  		  it "Compota de manzana" do
  		    @compota = Cnutrientes.new("Compota",1,1,1)
  		    ...
  		    @compota.calculate_index(datos,glucosa)
  		    expect(@compota.index).to eq(54.499780077077745)
  		  end
  		  it "Yogurt" do
  		    @yog = Cnutrientes.new("Yogurt",1,1,1)
  		    datos = [[6.1, 6.6, 6.3, 6.3 ,6.1 ,6.9, 6.8, 6.5, 6.4, 6.9, 6.8, 6.5, 6.3, 6.2, 6.7, 6.2, 5.9 ,5.8, 5.8, 5.8, 5.8 ,5.8 ,5.9 ,6.2, 6.4],[4.9, 4.9, 5.2, 5.8, 6.5, 7.0, 7.2, 7.3, 7.3, 6.6, 6.2, 6.1, 6.0, 6.1, 5.9, 5.9, 5.9 ,5.9, 5.8, 5.8, 5.5, 5.5, 5.6 ,5.9, 5.9]]
  		    glucosa = [[4.9 ,5.3 ,5.9 ,6.7 ,7.2 ,7.6 ,8.0 ,8.2, 8.2 ,8.4 ,8.3 ,8.3 ,8.0 ,7.5, 7.1, 6.8 ,6.8 ,6.9, 6.8, 6.3 ,6.2 ,6.3 ,6.2 ,6.3, 6.1],[6.3, 5.4, 5.6, 5.7, 6.5, 7.4, 7.9, 7.4, 7.7, 7.9, 7.9, 7.8, 7.8, 7.8, 8.0, 8.5, 9.4 ,10.8 ,10.5, 9.1, 8.9, 8.3, 7.7, 7.6 ,7.5]]
  		    @yog.calculate_index(datos,glucosa)
  		    expect(@yog.index).to eq(41.37941416722519)
  		  end
  		  it "Chocolate" do
  		    ...
  		    glucosa = [[4.9 ,5.3 ,5.9 ,6.7 ,7.2 ,7.6 ,8.0 ,8.2, 8.2 ,8.4 ,8.3 ,8.3 ,8.0 ,7.5, 7.1, 6.8 ,6.8 ,6.9, 6.8, 6.3 ,6.2 ,6.3 ,6.2 ,6.3, 6.1],[6.3, 5.4, 5.6, 5.7, 6.5, 7.4, 7.9, 7.4, 7.7, 7.9, 7.9, 7.8, 7.8, 7.8, 8.0, 8.5, 9.4 ,10.8 ,10.5, 9.1, 8.9, 8.3, 7.7, 7.6 ,7.5]]
  		    @yog.calculate_index(datos,glucosa)
  		    expect(@yog.index).to eq(13.328114527479904)
  		  end
end
